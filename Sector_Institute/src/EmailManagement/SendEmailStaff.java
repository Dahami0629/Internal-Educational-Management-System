...
public class SendEmailStaff extends javax.swing.JFrame {
        ...
        try
            {
                ...
                while(res.next())
                {
                    EmployeeID.add(res.getString("id"));
                }
    ...
    private void initComponents() {
        ...
        emailback = new javax.swing.JButton();
        jPanel4 = new javax.swing.JPanel();
        jPanel2 = new javax.swing.JPanel();
        SaveEmployee = new javax.swing.JButton();
        jLabel6 = new javax.swing.JLabel();
        EmployeeID = new java.awt.Choice();
        jPanel1 = new javax.swing.JPanel();
        jLabel3 = new javax.swing.JLabel();
        ToMail = new javax.swing.JTextField();
        sendEmployee = new javax.swing.JButton();
        ...
        emailback.setBackground(new java.awt.Color(0, 102, 102));
        emailback.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        emailback.setForeground(new java.awt.Color(255, 255, 255));
        emailback.setText("Back");
        emailback.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255), 2));
        emailback.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                emailbackActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addComponent(emailback, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(74, 74, 74))
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(emailback, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        SaveEmployee.setBackground(new java.awt.Color(0, 102, 102));
        SaveEmployee.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        SaveEmployee.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(SaveEmployee, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        sendEmployee.setBackground(new java.awt.Color(204, 0, 0));
        sendEmployee.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        sendEmployee.setForeground(new java.awt.Color(255, 255, 255));
        sendEmployee.setText("Send");
        sendEmployee.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                sendEmployeeActionPerformed(evt);
            }
        });
        ...
        jLabel2.setText("Send Email - Staff");
    ...
    private void SaveEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveEmployeeActionPerformed
        try{
            stmt = conn.createStatement();
            String sql = "SELECT mail FROM staff WHERE id = '"+EmployeeID.getSelectedItem()+"'";
    ...
    private void sendEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendEmployeeActionPerformed
    ...
    }//GEN-LAST:event_sendEmployeeActionPerformed
    ...
    private void emailbackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_emailbackActionPerformed
                setVisible(false);
                EmailCategory object = new EmailCategory();
                object.setVisible(true);
    }//GEN-LAST:event_emailbackActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SendEmailStaff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SendEmailStaff().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private java.awt.Choice EmployeeID;
    ...
    private javax.swing.JButton emailback;
    ...
    private javax.swing.JButton sendEmployee;
