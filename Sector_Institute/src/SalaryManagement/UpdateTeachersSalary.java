...
public class UpdateTeachersSalary extends javax.swing.JFrame {

    Connection conn = null;
    Statement stmt = null;   
    ResultSet rs = null;
    
    public UpdateTeachersSalary() {
        super("UpdateTeacherSalary");
        initComponents();
...
public void ChangeTName(){
    ...
    private void initComponents() {
        ...
        ATSCheck = new javax.swing.JButton();
        ...
        PreviousSalary = new javax.swing.JLabel();
        DeleteTeacherSalary = new javax.swing.JButton();
        ...
        jLabel1.setText("Edit Teachers' Salary");
        ...
        ATSCheck.setBackground(new java.awt.Color(0, 102, 102));
        ATSCheck.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ATSCheck.setForeground(new java.awt.Color(255, 255, 255));
        ATSCheck.setText("Check");
        ATSCheck.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ATSCheckActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(ATSCheck, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(ATSCheck, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel16.setText("Due Monthly Salary");

        PreviousSalary.setBackground(new java.awt.Color(255, 255, 255));
        PreviousSalary.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        PreviousSalary.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        PreviousSalary.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        DeleteTeacherSalary.setBackground(new java.awt.Color(255, 51, 51));
        DeleteTeacherSalary.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        DeleteTeacherSalary.setForeground(new java.awt.Color(255, 255, 255));
        DeleteTeacherSalary.setText("Delete");
        DeleteTeacherSalary.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                DeleteTeacherSalaryActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel5Layout.createSequentialGroup()
                                ...
                                .addComponent(DeleteTeacherSalary, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jLabel16)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(PreviousSalary, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(DeleteTeacherSalary, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(PreviousSalary, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(34, 34, 34))
        );
    ...
    private void ATSCheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ATSCheckActionPerformed
        if(ATSGrade.getSelectedItem() == "12")
        {
            ...
            try{
                ...
                String sql = "SELECT monthly_salary FROM g12_teacher_salary WHERE tid = '" + atsID + "' AND month = '" + atsMonth +"'";
                rs = stmt.executeQuery(sql);

                if(rs.next())
                {
                    PreviousSalary.setText("Rs " +rs.getString("monthly_salary"));
                }
                else
                {
                    JOptionPane.showMessageDialog(null,"Record Not found");
        ...
        else
        {
            ...
            try{
                ...
                String sql = "SELECT monthly_salary FROM g13_teacher_salary WHERE tid = '" + atsID + "' AND month = '" + atsMonth +"'";
                rs = stmt.executeQuery(sql);
    ...
    }//GEN-LAST:event_ATSCheckActionPerformed
                 ...
                 double sFee3 = 0.0;
                     try {
                         ...
                         return; // Exit the method if fee is not valid
                            ...
                            String sql = "UPDATE g12_teacher_salary SET " +
                                         "month = '" + atsMonth + "', " +
                                         "student_fee = '" + sFee + "', " +
                                         "total_students = '" + atsTotalStudents + "', " +
                                         "paid_students = '" + atsPaidStudents + "', " +
                                         "notpaid_students = '" + atsNotPaidStudents + "', " +
                                         "total_fees = '" + sFee1 + "', " +
                                         "monthly_salary = '" + sFee2 + "', " +
                                         "institute_fee = '" + sFee3 + "' " +
                                         "WHERE tid = '" + atsID + "' AND month = '" + atsMonth + "'";

                            stmt.executeUpdate(sql);
                            JOptionPane.showMessageDialog(null, "Payment record successfully updated.");
        ...
        else
            {
                try{
                 ...
                 double sFee3 = 0.0;
                     ...
                     String sql = "UPDATE g13_teacher_salary SET " +
                                         "month = '" + atsMonth + "', " +
                                         "student_fee = '" + sFee + "', " +
                                         "total_students = '" + atsTotalStudents + "', " +
                                         "paid_students = '" + atsPaidStudents + "', " +
    ...
    private void DeleteTeacherSalaryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteTeacherSalaryActionPerformed
      try{
            stmt = conn.createStatement();           
            String tid = ATSTeacherID.getSelectedItem();
            String atsMonth = (String) ATSSelectMonth.getSelectedItem();
             
            if (ATSGrade.getSelectedItem() == "12")
                {
                                
                        String sql = "DELETE FROM g12_teacher_salary  WHERE (tid, month) = ('"+tid+"','"+atsMonth+"')";
            ...
            else
                {
                        ...
                        String sql = "DELETE FROM g13_teacher_salary  WHERE (tid, month) = ('"+tid+"','"+atsMonth+"')";
    ...
    }//GEN-LAST:event_DeleteTeacherSalaryActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateTeachersSalary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateTeachersSalary().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton ATSCheck;
    ...
    private javax.swing.JButton DeleteTeacherSalary;
    private javax.swing.JLabel PaidAmountTotal;
    private javax.swing.JLabel PreviousSalary;
