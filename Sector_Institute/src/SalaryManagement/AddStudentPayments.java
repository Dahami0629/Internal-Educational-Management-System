...
public class AddStudentPayments extends javax.swing.JFrame {

    Connection conn = null;
    Statement stmt = null;
    ResultSet rs = null;
 
    public AddStudentPayments() {
        super("HanldeStudentPaymnets");
        initComponents();
    ...
    private void substudentExistingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_substudentExistingActionPerformed
        if (SelectGrade.getSelectedItem() == "12")
        {
            try {
                ...
                if (tid.isEmpty() || sID.isEmpty() || sMonth.isEmpty() || spayment.isEmpty())
                {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            JOptionPane.showMessageDialog(null, "Student Not paid.");
                        }
        ...
        else
        {
            try{
                ...
                if (tid.isEmpty() || sID.isEmpty() || senroll_sub.isEmpty() || sMonth.isEmpty() || spayment.isEmpty())
                {
                    JOptionPane.showMessageDialog(null, "Please fill in all fields.");
                    return; // Stop further execution
                }
                else
                {
                    ...
                    if(res.next()){
                        ...
                        {
                            String sql1 = "INSERT INTO g13_enrollment (month,tid,sid,payment,fees,nic,mail) VALUES ('" + sMonth + "','" + tid + "','" + sID + "','" + spayment + "',0,'" + sNic + "','" + sMail + "')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddStudentPayments.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddStudentPayments().setVisible(true);
            }
        });
    }
