...
public class UpdateStudentPayments extends javax.swing.JFrame {
    
    Connection conn = null;
    Statement stmt = null;
    ResultSet rs = null;

    public UpdateStudentPayments() {
        super("UpdateStudentPaymnets");
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Student Monthly Payments");
        ...
        substudentExisting.setText("Update");
        ...
        PaymentCombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Paid" }));
        ...
        CurrentStatus.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        CurrentStatus.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));

        CheckStatus.setBackground(new java.awt.Color(0, 102, 102));
        CheckStatus.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        DeletePayment.setBackground(new java.awt.Color(255, 51, 51));
        DeletePayment.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        DeletePayment.setForeground(new java.awt.Color(255, 255, 255));
        DeletePayment.setText("Delete");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(DeletePayment, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(CurrentStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(CheckStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 86, javax.swing.GroupLayout.PREFERRED_SIZE)))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(CurrentStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(CheckStatus, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(14, 14, 14)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(DeletePayment, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void substudentExistingActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_substudentExistingActionPerformed
        if (SelectGrade.getSelectedItem() == "12")
        {
            try {
                ...
                {
                    String sql10 = "SELECT * from g12_enrollment WHERE (tid, sid,month,payment) = ('"+tid+"','"+sID+"','"+sMonth+"','Paid')";
                    ResultSet res = stmt.executeQuery(sql10);

                    if(res.next())
                    {
                        JOptionPane.showMessageDialog(this, "Student already paid for this month.");
                    }
                    else
                    {                                               
                            String sql1 = "UPDATE g12_enrollment SET payment ='" + spayment + "' ,fees ='" + sFee + "' WHERE (tid, sid,month) = ('"+tid+"','"+sID+"','"+sMonth+"')";

                            stmt.executeUpdate(sql1);

                            JOptionPane.showMessageDialog(null, "Student payment accepted.");
                    }
        ...
        else
        {
            try{
                ...
                {
                    String sql10 = "SELECT * from g13_enrollment WHERE (tid, sid,month,payment) = ('"+tid+"','"+sID+"','"+sMonth+"','Paid')";
                    ResultSet res = stmt.executeQuery(sql10);
                    ...
                    if(res.next()){
                       ...
                       String sql1 = "UPDATE g13_enrollment SET payment ='" + spayment + "' ,fees ='" + sFee + "' WHERE (tid, sid,month) = ('"+tid+"','"+sID+"','"+sMonth+"')";
    ...
    private void CheckStatusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_CheckStatusActionPerformed
        ...
        try{
            stmt = conn.createStatement();
            String sid = studentID.getText();
            String nic = studentID.getText();
            String tid = Tid.getSelectedItem();
            String sMonth = (String) SelectMonth.getSelectedItem();

            if (SelectGrade.getSelectedItem() == "12")
            {
                String sql = "SELECT payment FROM g12_enrollment WHERE sid = '"+sid+"' AND tid = '" + tid + "' AND month = '" + sMonth + "' ";
                    rs = stmt.executeQuery(sql);

                    if(rs.next())
                    {                      
                        CurrentStatus.setText(rs.getString("payment"));                       

                    }
                    else
                    {
                        JOptionPane.showMessageDialog(null,"Student payment record not found");
                    }

            }
            else
            {
              String sql = "SELECT * FROM g13_enrollment WHERE sid = '"+sid+"' AND tid = '" + tid + "' AND month = '" + sMonth + "' ";
                    rs = stmt.executeQuery(sql);
            ...
            if (SelectGrade.getSelectedItem() == "12")
                {
                        ...
                        String sql = "DELETE FROM g12_enrollment  WHERE (tid, sid, month) = ('"+tid+"','"+sid+"','"+sMonth+"')";
            ...
            else
                {
                        ...
                        String sql = "DELETE FROM g13_enrollment  WHERE (tid, sid, month) = ('"+tid+"','"+sid+"','"+sMonth+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateStudentPayments.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UpdateStudentPayments().setVisible(true);
            }
        });
    }
